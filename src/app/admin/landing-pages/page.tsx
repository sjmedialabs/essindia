  ...
  return (
    <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
      <motion.div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
          <h1 className="font-semibold text-slate-900 font-sans">Landing Page Templates</h1>
          <p className="text-slate-500 font-sans">View and use high-converting templates specifically built for Landing Pages.</p>
        </div>
      </motion.div>
      ...
      <div className="admin-compact-card overflow-hidden">
        <div className="flex items-center justify-between gap-3 border-b border-slate-200 px-4 py-2.5">
          <div className="relative flex-1 max-w-xs">
            ...
            <input
              type="text"
              placeholder="Search landing templates..."
              value={searchQuery}
        ...
        <div className="divide-y divide-slate-100">
          {isLoading ? (
            ...
            <div className="p-12 text-center text-xs text-slate-400">No landing templates yet. Run seeding scripts or create templates.</div>
          ) : (
